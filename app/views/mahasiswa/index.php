        ...
        <ul class="list-group">
          <?php foreach( $data['mhs'] as $mhs ) : ?>
            <li class="list-group-item">
                <?= $mhs['nama']; ?>
                <a href="javascript:;" onclick="confirmation('Penghapusan Data','Data yg telah dihapus tidak dapat dikembalikan lagi!','<?php echo BASEURL; ?>/mahasiswa/hapus/<?= $mhs['id']; ?>')" class="badge badge-danger float-right" onclick="return confirm('yakin?');">hapus</a>
